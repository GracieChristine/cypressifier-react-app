...
const SplashPage = ({ setCurrentView }) => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-royal-50/30 to-elegant-50/50 relative overflow-hidden flex flex-col">
      ...
      {/* Hero Section */}
      <div className="relative z-10 flex-1 flex items-center pt-36">
