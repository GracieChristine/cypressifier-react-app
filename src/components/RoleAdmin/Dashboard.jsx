...
const AdminDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-elegant-50 to-royal-50/30 py-4 px-3 sm:py-6 sm:px-6 lg:px-8" data-cy="dashboard">
      <div className="max-w-full px-4">

        {/* Header */}
        <div className="mb-8" data-cy="dashboard-header">
          <div className="flex flex-col sm:flex-row sm:items-center gap-2 mb-2">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-display text-royal-900">Admin Dashboard</h1>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-4 mb-6" data-cy="dashboard-status">
          <div className="flex gap-2 flex-wrap justify-center sm:justify-start">
            <div className="px-4 py-2 rounded bg-gray-100 text-gray-700 flex-1 text-center min-w-[100px] sm:min-w-[120px] whitespace-nowrap" data-cy="dashboard-status-box">
              All ({statusCounts.total})
            </div>
            <div className="px-4 py-2 rounded bg-blue-100 text-blue-700 flex-1 text-center min-w-[100px] sm:min-w-[120px] whitespace-nowrap" data-cy="dashboard-status-box">
              Submitted ({statusCounts.submitted})
            </div>
            <div className="px-4 py-2 rounded bg-yellow-100 text-yellow-700 flex-1 text-center min-w-[100px] sm:min-w-[120px] whitespace-nowrap" data-cy="dashboard-status-box">
              In Progress ({statusCounts.inProgress})
            </div>
            <div className="px-4 py-2 rounded bg-green-100 text-green-700 flex-1 text-center min-w-[100px] sm:min-w-[120px] whitespace-nowrap" data-cy="dashboard-status-box">
              Completed ({statusCounts.completed})
            </div>
            <div className="px-4 py-2 rounded bg-red-100 text-red-700 flex-1 text-center min-w-[100px] sm:min-w-[120px] whitespace-nowrap" data-cy="dashboard-status-box">
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-royal-700 text-white">
                <tr>
                  <th className="px-4 sm:px-6 py-4 text-left font-sans text-sm">Event</th>
                   <th className="px-4 sm:px-6 py-4 text-left font-sans text-sm">Date</th>
                  <th className="px-4 sm:px-6 py-4 text-left font-sans text-sm">Client</th>
                  <th className="px-4 sm:px-6 py-4 text-left font-sans text-sm">Type</th>
                  <th className="px-4 sm:px-6 py-4 text-left font-sans text-sm">Budget</th>
                  <th className="px-4 sm:px-6 py-4 text-left font-sans text-sm">Status</th>
                  <th className="px-4 sm:px-6 py-4 text-center font-sans text-sm">Actions</th>
                </tr>
              </thead>
                        ...
                        <td className="px-3 sm:px-6 py-3 sm:py-4">
                          <div className="flex flex-col gap-2">
                            <span className={`px-3 py-1 rounded text-xs font-semibold inline-flex 
                                ...
                                max-w-[110px] sm:min-w-[140px] sm:min-w-[160px] md:min-w-[180px] text-center ${getStatusColor(event.status)}`}
                              title={event.status}
                            >
                              {event.status}
                            </span>
                            {event.status === 'Submitted' && (
                              <span className={`px-3 py-1 rounded text-xs font-semibold inline-flex items-center justify-center max-w-[110px] sm:min-w-[140px] sm:min-w-[160px] md:min-w-[180px] text-center ${getPendingBadgeStyle()}`}>
                                Reviewing Event
                              </span>
                            )}
                            ...
                            {event.autoCancelled && (
                              <span className="px-2 py-1 rounded text-xs inline-flex items-center justify-center max-w-[110px] sm:min-w-[140px] sm:min-w-[160px] md:min-w-[180px] text-center bg-gray-100 text-gray-600">
                                Auto-cancelled
                              </span>
                            )}
                          </div>
                            ...
                            {isActiveInProgress ? (
                              ...
                              <>
                                <button
                                  ...
                                  className="w-full sm:w-auto min-w-[80px] sm:min-w-[90px] h-9 sm:h-8 py-1.5 bg-indigo-100 hover:bg-indigo-200 text-indigo-700 rounded text-sm font-medium transition whitespace-nowrap flex items-center justify-center"
                                ...
                                <button
                                  ...
                                  className="w-full sm:w-auto min-w-[80px] sm:min-w-[90px] h-9 sm:h-8 py-1.5 bg-lime-100 hover:bg-lime-200 text-lime-700 rounded text-sm font-medium transition whitespace-nowrap flex items-center justify-center"
                              ...
                              <button
                                ...
                                className="w-full sm:w-auto min-w-[80px] sm:min-w-[90px] h-9 sm:h-8 py-1.5 bg-purple-100 hover:bg-purple-200 text-purple-700 rounded text-sm font-medium transition whitespace-nowrap flex items-center justify-center"
